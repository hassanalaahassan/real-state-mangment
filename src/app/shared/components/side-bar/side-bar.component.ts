...
export class SidebarComponent implements OnInit {
  ...
  get sidebarClasses(): string {
    const baseClasses = 'h-dvh max-h-dvh relative flex flex-col h-screen bg-white border-r border-realty-gray-200 shadow-xl transition-all duration-300 ease-in-out z-30 py-2';
